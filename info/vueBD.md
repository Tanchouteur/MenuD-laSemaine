...
SELECT
    ...
    CASE
        WHEN cc.nom_plat_complet IS NOT NULL THEN cc.nom_plat_complet
        ELSE CONCAT(
                v1.nom_viande,
                CASE
    ...
    CASE
        WHEN cc2.nom_plat_complet IS NOT NULL THEN cc2.nom_plat_complet
        ELSE CONCAT(
                v2.nom_viande,
                CASE
    ...
    CASE
        WHEN cc3.nom_plat_complet IS NOT NULL THEN cc3.nom_plat_complet
        ELSE CONCAT(
                v3.nom_viande,
                CASE
    ...
    CASE
        WHEN cc4.nom_plat_complet IS NOT NULL THEN cc4.nom_plat_complet
        ELSE CONCAT(
                v4.nom_viande,
                CASE
...
FROM Menu
         ...
         LEFT JOIN plat_complet cc ON p1.plat_id = cc.plat_id
         ...
         LEFT JOIN plat_complet cc2 ON p2.plat_id = cc2.plat_id
         ...
         LEFT JOIN plat_complet cc3 ON p3.plat_id = cc3.plat_id
         ...
         LEFT JOIN plat_complet cc4 ON p4.plat_id = cc4.plat_id
...
FROM Plat p
         LEFT JOIN plat_complet cc ON p.plat_id = cc.plat_id  -- Jointure avec PlatComplet
